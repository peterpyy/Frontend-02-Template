...
export class Carousel extends Component{
    ...
    render(){
        ...
        this.root.addEventListener("panend",event => {
            ...
            if(event.isFlick){
                if(event.velocity > 0){
                    direction = Match.ceil((x % 500) / 500)
                }else{
                    direction = Match.floor((x % 500) / 500)
                }
            }
            ...
            for(let offset of [-1,0,1]) {
                ...
                timeline.add(new Animation(current.style,"tranform")
                ,- pos * 500 + offset * 500 + x % 500 +x % 500,
                 - pos * 500 + offset * 500 + direction + direction * 500,
